...
{
	PrintWarning('La risposta alla domanda è incompleta. È necessario selezionare almeno una risposta', questionIndex);  // "Prima di proseguire devi rispondere alla domanda"
}

function PrintNeedToAnswerAllItem(questionIndex)
{
	PrintWarning('La risposta alla domanda è incompleta. È necessario selezionare tutte le uscite', questionIndex);  // "Prima di proseguire devi rispondere al tutte le uscite"
}
